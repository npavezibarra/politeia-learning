...
class Politeia_Post_Reading_Render
{
	...
	{
		if (get_option('politeia_bookshelf_enable_post_reading', 'no') === 'no') {
			return false;
		}
		...
		if (!file_exists($template)) {
			...
			<div class="politeia-post-reading-wrap">
				<div class="politeia-post-reading-inner">
					<button type="button" class="politeia-post-reading-btn<?php echo esc_attr($extra_cls); ?>" <?php echo $is_logged ? '' : 'disabled'; ?>>
