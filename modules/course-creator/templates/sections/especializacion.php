...
<div id="pcg-specialization-form-section" class="pcg-create-course-container" style="display:none;">
    ...
    <div class="pcg-form-nav">
        ...
        <div class="pcg-nav-right">
            <div class="pcg-segmented-control">
                ...
                <div class="pcg-segment pcg-spec-segment" data-value="meta">
    ...
    <!-- START: META MODE -->
    <div id="pcg-spec-mode-meta" class="pcg-mode-content" style="display:none;">
        <div class="pcg-meta-card">
            <h3 class="pcg-meta-title"><?php _e('META DE LA ESPECIALIZACIÓN', 'politeia-learning'); ?></h3>

            <div class="pcg-meta-section">
                <label><?php _e('CATEGORÍAS', 'politeia-learning'); ?></label>
                <div class="pcg-meta-cat-picker" data-entity="group">
                    <div class="pcg-meta-cat-level pcg-meta-cat-level--l1" id="pcg-group-meta-cat-l1" aria-live="polite"></div>
                    <div class="pcg-meta-cat-level pcg-meta-cat-level--l2" id="pcg-group-meta-cat-l2" aria-live="polite"></div>
                    <div class="pcg-meta-cat-level pcg-meta-cat-level--l3" id="pcg-group-meta-cat-l3" aria-live="polite"></div>
                </div>
            </div>

            <div class="pcg-meta-section">
                <label for="pcg-group-meta-tag-input"><?php _e('ETIQUETAS', 'politeia-learning'); ?></label>
                <div class="pcg-meta-tags">
                    <div id="pcg-group-meta-tag-chips" class="pcg-meta-chips" aria-live="polite"></div>
                    <input type="text" id="pcg-group-meta-tag-input" class="pcg-modern-input pcg-meta-tag-input"
                        placeholder="<?php esc_attr_e('Escribe para buscar o crear...', 'politeia-learning'); ?>" autocomplete="off" />
                    <div id="pcg-group-meta-tag-suggestions" class="pcg-meta-suggestions"></div>
                </div>
            </div>
        </div>
    </div>
