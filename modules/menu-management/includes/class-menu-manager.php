...
class PL_MM_Menu_Manager
{
    ...
    public function enqueue_fixed_header_styles(): void
    {
        ...
        $css = ''
            ...
            . 'background:#f3f3f3;'
            . '}'
            . '.pl-user-menu__dropdown-item--stats a::before{'
            . 'content:"";'
            . 'width:14px;'
            . 'height:14px;'
            . 'margin-right:10px;'
            . 'background:currentColor;'
            . '-webkit-mask:url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\'><path fill=\'%23000\' d=\'M6 2h9l5 5v15H6V2zm8 1.5V8h4.5L14 3.5zM8 12h8v1.5H8V12zm0 3h8v1.5H8V15zm0-6h5v1.5H8V9z\'/></svg>") no-repeat center / contain;'
            . 'mask:url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\'><path fill=\'%23000\' d=\'M6 2h9l5 5v15H6V2zm8 1.5V8h4.5L14 3.5zM8 12h8v1.5H8V12zm0 3h8v1.5H8V15zm0-6h5v1.5H8V9z\'/></svg>") no-repeat center / contain;'
            . '}'
