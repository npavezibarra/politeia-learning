...
class PL_MM_Menu_Manager
{
    ...
    public function enqueue_fixed_header_styles(): void
    {
        ...
        $css = ''
            ...
            . 'z-index:10000;'
            . '--pl-user-menu-speed:0.4s;'
            . '--pl-user-menu-bezier:cubic-bezier(0.175,0.885,0.32,1.275);'
            . 'opacity:0;'
            . 'visibility:hidden;'
            . 'pointer-events:none;'
            . 'transform-origin:top center;'
            . 'transform:perspective(1000px) rotateX(-90deg);'
            . 'transition:opacity var(--pl-user-menu-speed) ease,transform var(--pl-user-menu-speed) var(--pl-user-menu-bezier),visibility var(--pl-user-menu-speed);'
            . '}'
            ...
            . 'ul.pl-user-menu__dropdown{transition:none !important;transform:none !important;}'
            . '.pl-user-menu-item.is-open ul.pl-user-menu__dropdown{transform:none !important;}'
            . '}'
            . '.pl-user-menu__toggle{'
            ...
            . 'height:12px;'
            . 'display:block;'
            . 'transition:transform 0.4s var(--pl-user-menu-bezier);'
            . '}'
