                ...
                <div style="padding: 0 32px 32px 32px;">
                    <div class="receipt-card">
                        <table class="receipt-table" width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr>
                                <td class="receipt-label"><?php echo esc_html__('ID Pedido', 'politeia-learning'); ?></td>
                            ...
                            <tr>
                                <td class="receipt-label"><?php echo esc_html__('Método de pago', 'politeia-learning'); ?></td>
                                <td class="receipt-value"><?php echo esc_html($order->get_payment_method_title()); ?></td>
                            </tr>
                            <tr>
                                <td class="receipt-label"><?php echo esc_html__('Subtotal', 'politeia-learning'); ?></td>
                                <td class="receipt-value"><?php echo wp_kses_post($subtotal); ?></td>
                            </tr>
                            <tr class="receipt-total-row">
                                <td class="receipt-label" style="font-weight: 700; color: #111827;"><?php echo esc_html__('Total a transferir', 'politeia-learning'); ?></td>
