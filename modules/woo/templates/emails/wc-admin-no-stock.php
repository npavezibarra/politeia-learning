<?php
/**
 * Politeia custom WooCommerce admin no stock notification.
 *
...
<head>
    ...
    <title><?php echo esc_html($site_name); ?> - <?php echo esc_html__('Sin stock', 'politeia-learning'); ?></title>
    <style>
...
<div class="container">
    <div class="header">
        ...
        <span class="pill"><?php echo esc_html__('Sin stock', 'politeia-learning'); ?></span>
    ...
    <div class="content">
        <p class="muted"><?php echo esc_html__('Este producto se quedó sin stock.', 'politeia-learning'); ?></p>
        <table class="receipt">
