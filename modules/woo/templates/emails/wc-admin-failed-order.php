<?php
/**
 * Politeia custom WooCommerce admin "failed order" notification.
 *
 * @var WC_Order $order
 * @var string   $logo_url
 */
...
<head>
    ...
    <title><?php echo esc_html($site_name); ?> - <?php echo esc_html(sprintf(__('Pedido fallido #%s', 'politeia-learning'), $order_number)); ?></title>
    <style>
        ...
        .pill { display:inline-block; font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.12em; background:#ffedd5; color:#9a3412; padding: 6px 10px; border-radius: 999px; }
...
<div class="container">
    <div class="header">
        ...
        <span class="pill"><?php echo esc_html__('Fallido', 'politeia-learning'); ?></span>
