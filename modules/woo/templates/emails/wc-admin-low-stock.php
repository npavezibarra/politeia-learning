<?php
/**
 * Politeia custom WooCommerce admin low stock notification.
 *
...
<head>
    ...
    <title><?php echo esc_html($site_name); ?> - <?php echo esc_html__('Stock bajo', 'politeia-learning'); ?></title>
    <style>
        ...
        .pill { display:inline-block; font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.12em; background:#fffbeb; color:#92400e; padding: 6px 10px; border-radius: 999px; }
...
<div class="container">
    <div class="header">
        ...
        <span class="pill"><?php echo esc_html__('Stock bajo', 'politeia-learning'); ?></span>
    ...
    <div class="content">
        <p class="muted"><?php echo esc_html__('El stock de este producto está bajo.', 'politeia-learning'); ?></p>
        <table class="receipt">
