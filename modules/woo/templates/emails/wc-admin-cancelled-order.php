<?php
/**
 * Politeia custom WooCommerce admin "cancelled order" notification.
 *
 * @var WC_Order $order
 * @var string   $logo_url
 */
...
<head>
    ...
    <title><?php echo esc_html($site_name); ?> - <?php echo esc_html(sprintf(__('Pedido cancelado #%s', 'politeia-learning'), $order_number)); ?></title>
    <style>
...
<div class="container">
    ...
    <div class="content">
        <p class="muted"><?php echo esc_html__('Se canceló un pedido. Revisa el detalle en WooCommerce.', 'politeia-learning'); ?></p>
        <div style="margin-top: 24px;">
            <header style="margin-bottom: 32px; text-align: center;">
                <h2 style="font-size: 20px; font-weight: 900; color: #000000; text-transform: uppercase; letter-spacing: -0.05em; margin: 0;"><?php echo esc_html__('Resumen de Cancelación', 'politeia-learning'); ?></h2>
