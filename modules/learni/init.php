...
require_once PL_LEARNI_PATH . 'includes/Rest/Binomial.php';
require_once PL_LEARNI_PATH . 'includes/Rest/Attempts.php';
require_once PL_LEARNI_PATH . 'includes/Rest/Certificates.php';
require_once PL_LEARNI_PATH . 'includes/Rest/CrossEval.php';
