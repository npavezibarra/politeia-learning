 ...
 *
 * Politeia override: adds a full-width top bar placeholder.
 *
 * @since 4.22.0
 * @version 4.22.0
 *
...
$template_parts_root = dirname( __DIR__, 4 ) . '/template-parts';

if ( file_exists( $template_parts_root . '/learndash/group-topbar.php' ) ) {
	include $template_parts_root . '/learndash/group-topbar.php';
}
...
<?php
$this->template( 'modern/group/courses' );
