<?php
/**
 * Template for the Email Log table tab.
 * 
 * Variables available:
 * @var array  $logs
 * @var int    $total_count
        ...
        <?php if (!empty($logs)): ?>
            <?php foreach ($logs as $log): ?>
                <tr>
                    ...
                    <td>
                        <span class="pl-badge type-<?php echo esc_attr(strtolower((string) $log->email_type)); ?>">
    ...
    <div class="tablenav bottom">
        <div class="tablenav-pages">
            ...
            <span class="pagination-links">
                <?php if ($paged > 1): ?>
                    <a class="prev-page button" href="<?php echo esc_url(add_query_arg(['paged' => $paged - 1, 'tab' => 'email-log'])); ?>">&lsaquo;</a>
                <?php endif; ?>
                ...
                <?php if ($paged < $total_pages): ?>
                    <a class="next-page button" href="<?php echo esc_url(add_query_arg(['paged' => $paged + 1, 'tab' => 'email-log'])); ?>">&rsaquo;</a>
                <?php endif; ?>
            </span>
        </div>
    </div>
