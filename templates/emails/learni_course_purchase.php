...
$pl_email_header_title = __('COMPRA DE CURSO', 'politeia-learning');
?>
<!doctype html>
            ...
            <tr id="pl-email-body">
              <td id="pl-email-body-content" align="center" style="padding:0 32px 30px;font-size:16px;line-height:1.6;color:#374151;">
                ...
                <p style="margin:0 0 16px;">
                  Felicitaciones por la compra del curso <strong><?php echo esc_html($course_name !== '' ? $course_name : '{{course_name}}'); ?></strong>.<br>
